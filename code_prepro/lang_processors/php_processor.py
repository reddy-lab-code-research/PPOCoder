...
PHP_CHAR2TOKEN = {value: " " + key + " " for key, value in PHP_TOKEN2CHAR.items()}


class PhpProcessor(TreeSitterLangProcessor):
    def __init__(self, root_folder):
        super().__init__(
            language="php",
            ast_nodes_type_string=["comment", "string_literal", "character_literal"],
            stokens_to_chars=PHP_TOKEN2CHAR,
            chars_to_stokens=PHP_CHAR2TOKEN,
