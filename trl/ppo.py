...
class PPOTrainer:
    ...
    def train_minibatch(self, logprobs, values, rewards, source_ids, source_mask, response_ids,response_ids_ref): 
        ...
        loss_p, loss_v,loss_node, train_stats  = self.loss(logprobs, values, rewards, source_ids, source_mask, response_ids,response_ids_ref)
        loss = loss_p + loss_v + loss_node
    ...
    def loss(self, old_logprobs, values, rewards, source_ids, source_mask, response_ids,response_ids_ref): ##MODIFIED
        ...
        loss = pg_loss + self.ppo_params['vf_coef'] * vf_loss + self.ppo_params['node_loss_coef'] * node_loss
        ...
        # breakpoint()
        return pg_loss, self.ppo_params['vf_coef'] * vf_loss, self.ppo_params['node_loss_coef'] * node_loss, flatten_dict(stats)
